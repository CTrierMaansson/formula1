...
bet_df_w <- bet_df(Christoffer = c("Hamilton", "Leclerc", "Sainz","Ricciardo"),
                   Emil = c("Verstappen", "Hamilton", "Pérez","Hamilton"),
                   Mikkel = c("Sainz", "Hamilton", "Leclerc","Sainz"))
...
df_results <- df_results %>% 
    mutate(surname = factor(surname, levels = df_results$surname))
ggplot(df_results,aes(x = surname, y = points,
           fill = surname)) +
...
point_calculator <- function(bet_df){
    ...
    joker_res_Christoffer <- ifelse(joker_Christoffer$time == "\\N",
                                    20-joker_Christoffer$grid,
                                    as.numeric(joker_Christoffer$position)-
                                                   joker_Christoffer$grid)
    ...
    joker_res_Emil <- ifelse(joker_Emil$time == "\\N",
                                    20-joker_Emil$grid,
    ...
    joker_res_Mikkel <- ifelse(joker_Mikkel$time == "\\N",
                                    20-joker_Mikkel$grid,
...
joker_plot <- function(bet_df){
    ...
    df <- data.frame(person = c(rep("Christoffer",2),
                     ...
                     type = factor(rep(c("Start","Slut"),3),
                                   levels = c("Start","Slut")),
                     position = c(as.numeric(joker_Christoffer$grid),
                                  ifelse(joker_Christoffer$time == "\\N",
                                         20,
                                         as.numeric(joker_Christoffer$position)),
                                  as.numeric(joker_Emil$grid),
                                  ifelse(joker_Emil$time == "\\N",
                                         20,
                                         as.numeric(joker_Emil$position)),
                                  as.numeric(joker_Mikkel$grid),
                                  ifelse(joker_Mikkel$time == "\\N",
                                         20,
                                         as.numeric(joker_Mikkel$position))),
...
list_of_bets <- list(point_calculator(bet_df_w))
