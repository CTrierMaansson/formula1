...
bet_df_w <- bet_df(Christoffer = c("Pérez", "Alonso", "Russell","Verstappen"),
                   Emil = c("Verstappen","Pérez","Alonso", "Verstappen"),
                   Mikkel = c("Pérez", "Verstappen", "Alonso","Verstappen"))
...
df <- readRDS("C:/Users/chris/OneDrive/1PhD/formula1/formula1/formula1_dataset/bet_results/Saudi Arabia.rds")
```
...
df_race <- read.csv("C:/Users/chris/OneDrive/1PhD/formula1/formula1/formula1_dataset/Formula1_2023season_raceResults.csv")
df_results <- rbind(df_1,df_2)
res_df <- df_results %>% filter(Bets == "Point")
res_df$place <- c("Bahrain", "Saudi Arabia")
...
res_df_gg <- data.frame(place = rep(res_df$place,3),
                        player = c(rep(colnames(res_df)[2],2),
                                   rep(colnames(res_df)[3],2),
                                   rep(colnames(res_df)[4],2)),
...
i forhold til hans holdkammerat. Størrelsen og farven på cirklen indikerer 
hvem mange på point køren har fået. På Y-aksen kan man se hvor mange point
